...
async def postrules(
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            "**2. Keep it SFW.** No NSFW, extreme gore, or\n"
            "explicit content anywhere in the server.\n\n"
            "**3. No spam or self-promotion.** Don't flood\n"
            "chat, mass-ping, or advertise other servers\n"
            "without permission.\n\n"
            "**4. Use the right channels.** Post content where\n"
            "it belongs and keep conversations on topic.\n\n"
            "**5. No drama or witch-hunting.** Keep\n"
            "disagreements civil and take serious issues\n"
            "to a moderator.\n\n"
            "**6. Listen to the staff team.** Moderators have\n"
            "the final say. Don't argue with decisions in\n"
            "public channels.\n\n"
            "**7. Follow Discord's Terms of Service and\n"
